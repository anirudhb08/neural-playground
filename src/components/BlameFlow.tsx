...
export function BlameFlow({ net, sample, glyphs }: Props) {
  ...
  return (
    <div className="border bg-paper-raised p-5 hairline">
        ...
        {STAGES.map((entry, i) => (
          <li key={entry.name}>
            <button
              ...
              className={`border px-3 py-1.5 mono-note transition-colors ${
                i === stage
      ...
      <p className="mt-4 max-w-[36rem] caption">
        {STAGES[stage].line}
      </p>
            ...
            {pass.reported.map((value, h) => {
              ...
              return (
                <li key={h} className="flex items-center gap-2.5">
                  <span className="w-7 shrink-0 mono-note text-graphite">
                    #{h}
                  </span>
                  ...
                  <span className="w-12 shrink-0 mono-note text-graphite">
                  ...
                  <span
                    className={`w-14 shrink-0 text-right mono-note ${
